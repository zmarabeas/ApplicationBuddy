        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="border-border bg-card">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">Read detailed guides and tutorials</p>
          ...
          <CardContent>
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-foreground">How does ApplicationBuddy detect form fields?</AccordionTrigger>
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger className="text-foreground">What file formats are supported for resume uploads?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
              ...
              <AccordionItem value="item-4">
                <AccordionTrigger className="text-foreground">How accurate is the auto-fill functionality?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
              ...
              <AccordionItem value="item-5">
                <AccordionTrigger className="text-foreground">Which browsers are supported?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
              ...
              <AccordionItem value="item-6">
                <AccordionTrigger className="text-foreground">How do I install the browser extension?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
        ...
        <Card className="border-border">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <h3 className="text-md font-medium text-foreground">Getting Started</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-md font-medium text-foreground">Troubleshooting</h3>
